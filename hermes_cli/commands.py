...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("autonomy", "Record and show autonomous-work state", "Session",
               args_hint="[status|pause|resume|clear]"),
...
_SLACK_VIA_HERMES_ONLY = frozenset({"topup", "moa", "debug", "autonomy"})
